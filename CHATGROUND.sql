...
CREATE TABLE CHATROOM(
	...
	CR_MEMRECORD CHAR(5) NOT NULL,
	CR_MEM1 CHAR(10),
	CR_MEM2 CHAR(10),
	CR_MEM3 CHAR(10),
	CR_MEM4 CHAR(10),
	CR_MEM5 CHAR(10),
	CONSTRAINT FK_CR_MEM1_MEM_NO
    FOREIGN KEY(CR_MEM1) REFERENCES MEMBERS(MEM_NO),
	CONSTRAINT FK_CR_MEM2_MEM_NO
    FOREIGN KEY(CR_MEM2) REFERENCES MEMBERS(MEM_NO),
	CONSTRAINT FK_CR_MEM3_MEM_NO
    FOREIGN KEY(CR_MEM3) REFERENCES MEMBERS(MEM_NO),
	CONSTRAINT FK_CR_MEM4_MEM_NO
    FOREIGN KEY(CR_MEM4) REFERENCES MEMBERS(MEM_NO),
	CONSTRAINT FK_CR_MEM5_MEM_NO
    FOREIGN KEY(CR_MEM5) REFERENCES MEMBERS(MEM_NO)
);
...
CREATE TABLE MEMCRSET (
    ...
    FOREIGN KEY(MEMCRSET_MEMNO) REFERENCES MEMBERS(MEM_NO),
...
CREATE TABLE MESSAGE (
    ...
    FOREIGN KEY(MSG_FROM) REFERENCES MEMBERS(MEM_NO),
